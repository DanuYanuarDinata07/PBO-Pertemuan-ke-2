...
phi.grid(row=0, column=0, sticky=W, padx=5, pady=5)

txtphi = Entry(frame)
txtphi.grid(row=0, column=1)
...
selimut.grid(row=2, column=0, sticky=W, padx=5, pady=5)

selimut = Entry(frame)
selimut.grid(row=2, column=1)

txtselimut = Entry(frame)
txtselimut.grid(row=2, column=1)
